...
<% 
    ...
    boolean isFound = (bean != null && bean.getAdmin_nickname().equals(nickname));
    String adminId = isFound ? bean.getAdmin_id() : "";
%>
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    <title>YUMMY JEJU - 관리자 아이디 찾기</title>
...
<body>
    <div class="login-container">
        ...
        <h2 class="login-header">관리자 아이디 찾기</h2>
        <form action="admin_Find_Id_Proc.jsp" method="post">
    ...
    <div class="popup-overlay" style="display: block;">
        <div class="popup-container <%= isFound ? "success-popup" : "error-popup" %>">
            <div class="popup-content">
                <h3 class="popup-title"><%= isFound ? "아이디 찾기 성공" : "아이디 찾기 실패" %></h3>
                <% if(isFound) { %>
                    <p class="popup-message">관리자 아이디를 찾았습니다.</p>
                    <div class="popup-id-box"><%= adminId %></div>
